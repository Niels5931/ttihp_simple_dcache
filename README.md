...
|---|---|---|
| `ui_in[3:0]` | `addr` | Cache address bits [3:0] (maps to 16 indexes, though cache is 8) |
| `ui_in[4]` | `valid` | CPU Request Valid |
| `ui_in[5]` | `write` | CPU Request Write (1=Write, 0=Read) |
| `ui_in[6]` | `wdata` | CPU Write Data (Bit 0) |
...
2. Set an address on `ui_in[3:0]`.
3. Assert `ui_in[4]` (Valid).
